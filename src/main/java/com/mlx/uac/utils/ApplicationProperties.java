...
public class ApplicationProperties {
	...
	private static final String[] files = { "weixin_app_login.properties", "weixin_wap_login.properties",
			"conf.properties", "regs.properties", "req.properties", "respCode.properties" };
